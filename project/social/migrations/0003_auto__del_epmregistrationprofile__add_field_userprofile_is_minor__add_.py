...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'EPMRegistrationProfile'
        db.delete_table(u'social_epmregistrationprofile')

        # Adding field 'UserProfile.is_minor'
        db.add_column(u'social_userprofile', 'is_minor',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.guardian_email'
        db.add_column(u'social_userprofile', 'guardian_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'EPMRegistrationProfile'
        db.create_table(u'social_epmregistrationprofile', (
        ...
        db.send_create_signal(u'social', ['EPMRegistrationProfile'])

        # Deleting field 'UserProfile.is_minor'
        db.delete_column(u'social_userprofile', 'is_minor')

        # Deleting field 'UserProfile.guardian_email'
        db.delete_column(u'social_userprofile', 'guardian_email')
