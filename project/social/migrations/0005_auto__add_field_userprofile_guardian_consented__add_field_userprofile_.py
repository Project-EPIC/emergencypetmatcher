...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.guardian_consented'
        db.add_column(u'social_userprofile', 'guardian_consented',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.guardian_activation_key'
        db.add_column(u'social_userprofile', 'guardian_activation_key',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.guardian_consented'
        db.delete_column(u'social_userprofile', 'guardian_consented')

        # Deleting field 'UserProfile.guardian_activation_key'
        db.delete_column(u'social_userprofile', 'guardian_activation_key')
