...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.social_profile'
        db.add_column(u'social_userprofile', 'social_profile',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.social_profile'
        db.delete_column(u'social_userprofile', 'social_profile')
