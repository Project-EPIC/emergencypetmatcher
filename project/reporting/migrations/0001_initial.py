...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reporting_petreport', (
            ...
            ('proposed_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='proposed_related', to=orm['socializing.UserProfile'])),
            ...
            ('contact_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('contact_number', self.gf('django.db.models.fields.CharField')(max_length=30, null=True)),
            ('contact_email', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('contact_link', self.gf('django.db.models.fields.CharField')(max_length=300, null=True)),
            ...
            ('pet_name', self.gf('django.db.models.fields.CharField')(default='Name unknown', max_length=15, null=True)),
            ('age', self.gf('django.db.models.fields.CharField')(default='Age unknown', max_length=10, null=True)),
            ('color', self.gf('django.db.models.fields.CharField')(default='Color(s) unknown', max_length=30, null=True)),
            ('breed', self.gf('django.db.models.fields.CharField')(default='Breed unknown', max_length=30, null=True)),
        ...
        db.send_create_signal(u'reporting', ['PetReport'])

        # Adding M2M table for field workers on 'PetReport'
        m2m_table_name = db.shorten_name(u'reporting_petreport_workers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('petreport', models.ForeignKey(orm[u'reporting.petreport'], null=False)),
            ('userprofile', models.ForeignKey(orm[u'socializing.userprofile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['petreport_id', 'userprofile_id'])

        # Adding M2M table for field bookmarked_by on 'PetReport'
        m2m_table_name = db.shorten_name(u'reporting_petreport_bookmarked_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('petreport', models.ForeignKey(orm[u'reporting.petreport'], null=False)),
            ('userprofile', models.ForeignKey(orm[u'socializing.userprofile'], null=False))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'reporting_petreport')

        # Removing M2M table for field workers on 'PetReport'
        db.delete_table(db.shorten_name(u'reporting_petreport_workers'))

        # Removing M2M table for field bookmarked_by on 'PetReport'
        db.delete_table(db.shorten_name(u'reporting_petreport_bookmarked_by'))
