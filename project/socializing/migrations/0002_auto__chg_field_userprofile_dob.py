...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.dob'
        db.alter_column(u'socializing_userprofile', 'dob', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.dob'
        db.alter_column(u'socializing_userprofile', 'dob', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        u'socializing.userprofile': {
            ...
            'dob': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 22, 0, 0)'}),
