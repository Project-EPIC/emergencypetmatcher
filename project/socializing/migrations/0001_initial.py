...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'socializing_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['auth.User'], unique=True)),
            ('img_path', self.gf('django.db.models.fields.files.ImageField')(default='userprofile/uploads/defaults/anonymous.gif', max_length=100, null=True)),
            ('thumb_path', self.gf('django.db.models.fields.files.ImageField')(default='userprofile/thumbnails/defaults/anonymous.gif', max_length=100, null=True)),
            ...
            ('social_profile', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_minor', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('guardian_consented', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('guardian_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True)),
            ('guardian_activation_key', self.gf('django.db.models.fields.CharField')(max_length=40, null=True)),
        ))
        db.send_create_signal(u'socializing', ['UserProfile'])

        # Adding M2M table for field following on 'UserProfile'
        m2m_table_name = db.shorten_name(u'socializing_userprofile_following')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_userprofile', models.ForeignKey(orm[u'socializing.userprofile'], null=False)),
            ('to_userprofile', models.ForeignKey(orm[u'socializing.userprofile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_userprofile_id', 'to_userprofile_id'])

        # Adding model 'EditUserProfile'
        db.create_table(u'socializing_edituserprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['auth.User'], unique=True)),
        ...
        db.send_create_signal(u'socializing', ['EditUserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'socializing_userprofile')

        # Removing M2M table for field following on 'UserProfile'
        db.delete_table(db.shorten_name(u'socializing_userprofile_following'))

        # Deleting model 'EditUserProfile'
        db.delete_table(u'socializing_edituserprofile')
