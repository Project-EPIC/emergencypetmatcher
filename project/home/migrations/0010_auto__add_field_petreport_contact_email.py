...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PetReport.contact_email'
        db.add_column('home_petreport', 'contact_email',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PetReport.contact_email'
        db.delete_column('home_petreport', 'contact_email')
