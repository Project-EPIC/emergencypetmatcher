...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PetReport.tag_info'
        db.alter_column('home_petreport', 'tag_info', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'PetReport.description'
        db.alter_column('home_petreport', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'PetMatch.description'
        db.alter_column('home_petmatch', 'description', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'PetReport.tag_info'
        db.alter_column('home_petreport', 'tag_info', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'PetReport.description'
        db.alter_column('home_petreport', 'description', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'PetMatch.description'
        db.alter_column('home_petmatch', 'description', self.gf('django.db.models.fields.CharField')(default='No Desc. available', max_length=300))
