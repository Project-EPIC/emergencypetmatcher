...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PetReport.spayed_or_neutered'
        db.add_column('home_petreport', 'spayed_or_neutered',
                      self.gf('django.db.models.fields.CharField')(default="Don't Know", max_length=10, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PetReport.spayed_or_neutered'
        db.delete_column('home_petreport', 'spayed_or_neutered')
    ...
    models = {
        ...
        'home.petreport': {
            ...
            'spayed_or_neutered': ('django.db.models.fields.CharField', [], {'default': '"Don\'t Know"', 'max_length': '10', 'null': 'True'}),
