...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PetReport.geo_location_lat'
        db.add_column('home_petreport', 'geo_location_lat',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=5),
                      keep_default=False)

        # Adding field 'PetReport.geo_location_long'
        db.add_column('home_petreport', 'geo_location_long',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=5),
                      keep_default=False)

        # Adding field 'PetReport.microchip_id'
        db.add_column('home_petreport', 'microchip_id',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'PetReport.tag_info'
        db.add_column('home_petreport', 'tag_info',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True),
                      keep_default=False)

        # Adding field 'PetReport.contact_name'
        db.add_column('home_petreport', 'contact_name',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'PetReport.contact_number'
        db.add_column('home_petreport', 'contact_number',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)


        # Changing field 'PetReport.size'
        db.alter_column('home_petreport', 'size', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'PetReport.sex'
        db.alter_column('home_petreport', 'sex', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))
    ...
    def backwards(self, orm):
        # Deleting field 'PetReport.geo_location_lat'
        db.delete_column('home_petreport', 'geo_location_lat')

        # Deleting field 'PetReport.geo_location_long'
        db.delete_column('home_petreport', 'geo_location_long')

        # Deleting field 'PetReport.microchip_id'
        db.delete_column('home_petreport', 'microchip_id')

        # Deleting field 'PetReport.tag_info'
        db.delete_column('home_petreport', 'tag_info')

        # Deleting field 'PetReport.contact_name'
        db.delete_column('home_petreport', 'contact_name')

        # Deleting field 'PetReport.contact_number'
        db.delete_column('home_petreport', 'contact_number')


        # User chose to not deal with backwards NULL issues for 'PetReport.size'
        raise RuntimeError("Cannot reverse this migration. 'PetReport.size' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PetReport.sex'
        raise RuntimeError("Cannot reverse this migration. 'PetReport.sex' and its values cannot be restored.")

        # Changing field 'PetReport.location'
        db.alter_column('home_petreport', 'location', self.gf('django.db.models.fields.CharField')(max_length=25))
    ...
    models = {
        ...
        'home.petreport': {
            ...
            'location': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True'}),
