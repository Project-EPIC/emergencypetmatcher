...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.test'
        db.alter_column('home_userprofile', 'test', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.test'
        db.alter_column('home_userprofile', 'test', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
