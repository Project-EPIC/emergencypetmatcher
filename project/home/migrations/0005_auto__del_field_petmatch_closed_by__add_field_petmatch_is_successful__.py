...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PetMatch.closed_by'
        db.delete_column('home_petmatch', 'closed_by_id')

        # Adding field 'PetMatch.is_successful'
        db.add_column('home_petmatch', 'is_successful',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PetMatch.verification_triggered'
        db.add_column('home_petmatch', 'verification_triggered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PetMatch.verification_votes'
        db.add_column('home_petmatch', 'verification_votes',
                      self.gf('django.db.models.fields.CharField')(default='00', max_length=2),
                      keep_default=False)


        # Changing field 'PetMatch.closed_date'
        db.alter_column('home_petmatch', 'closed_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Adding field 'PetMatch.closed_by'
        db.add_column('home_petmatch', 'closed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='closed_by_related', null=True, to=orm['home.UserProfile']),
                      keep_default=False)

        # Deleting field 'PetMatch.is_successful'
        db.delete_column('home_petmatch', 'is_successful')

        # Deleting field 'PetMatch.verification_triggered'
        db.delete_column('home_petmatch', 'verification_triggered')

        # Deleting field 'PetMatch.verification_votes'
        db.delete_column('home_petmatch', 'verification_votes')


        # Changing field 'PetMatch.closed_date'
        db.alter_column('home_petmatch', 'closed_date', self.gf('django.db.models.fields.DateField')(null=True))
