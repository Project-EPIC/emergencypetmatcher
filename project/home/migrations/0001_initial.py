...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('home_userprofile', (
            ...
            ('test', self.gf('django.db.models.fields.CharField')(max_length=500, null=True)),
            ('is_test', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('reputation', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True)),
        ))
        ...
        db.create_table('home_petreport', (
            ...
            ('location', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=25)),
            ('proposed_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['home.UserProfile'])),
            ...
            ('age', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=10, null=True)),
            ...
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=500, null=True)),
        ))
        ...
        db.create_table('home_petmatch', (
            ...
            ('proposed_date', self.gf('django.db.models.fields.DateTimeField')(default=None, auto_now_add=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(default=None, max_length=300)),
            ('is_open', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('closed_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='closed_by_related', null=True, to=orm['home.UserProfile'])),
            ('closed_date', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
    ...
    models = {
        ...
        'home.petmatch': {
            ...
            'closed_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'closed_by_related'", 'null': 'True', 'to': "orm['home.UserProfile']"}),
            'closed_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            ...
            'proposed_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'home.petreport': {
            ...
            'location': ('django.db.models.fields.CharField', [], {'default': "'unknown'", 'max_length': '25'}),
            ...
            'proposed_by': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['home.UserProfile']"}),
        ...
        'home.userprofile': {
            ...
            'reputation': ('django.db.models.fields.FloatField', [], {'default': '0.0', 'null': 'True'}),
            'test': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'default': 'None', 'to': "orm['auth.User']", 'unique': 'True'})
        }
    }
