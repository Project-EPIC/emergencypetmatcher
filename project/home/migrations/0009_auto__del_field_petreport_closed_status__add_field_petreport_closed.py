...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PetReport.closed_status'
        db.delete_column('home_petreport', 'closed_status')

        # Adding field 'PetReport.closed'
        db.add_column('home_petreport', 'closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PetReport.closed_status'
        db.add_column('home_petreport', 'closed_status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'PetReport.closed'
        db.delete_column('home_petreport', 'closed')
