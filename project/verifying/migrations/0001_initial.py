...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PetCheck'
        db.create_table(u'verifying_petcheck', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('petmatch', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['matching.PetMatch'], unique=True, null=True)),
        ...
        db.send_create_signal(u'verifying', ['PetCheck'])


    def backwards(self, orm):
        # Deleting model 'PetCheck'
        db.delete_table(u'verifying_petcheck')
    ...
    models = {
        ...
        u'verifying.petcheck': {
            'Meta': {'object_name': 'PetCheck'},
            'closed_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_successful': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'petmatch': ('django.db.models.fields.related.OneToOneField', [], {'default': 'None', 'to': u"orm['matching.PetMatch']", 'unique': 'True', 'null': 'True'}),
            'verification_votes': ('django.db.models.fields.CharField', [], {'default': "'00'", 'max_length': '2'})
        }
    }

    complete_apps = ['verifying']